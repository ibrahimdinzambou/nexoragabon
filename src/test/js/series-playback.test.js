...
test("le lecteur integre bloque les redirections externes", () => {
    ...
    assert.match(dedicated, /sandbox="allow-scripts allow-same-origin allow-forms allow-presentation"/);
    assert.doesNotMatch(dedicated, /allow-popups/);
    ...
    assert.match(dedicated, /const allowedNavigationHosts = new Set\(\["nexoragabon\.com", "www\.nexoragabon\.com"\]\)/);
